...
HD_PWD='C:/Users/mpi_l/OneDrive/Desktop/Morse/Morse.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source morse_top.tcl -notrace
