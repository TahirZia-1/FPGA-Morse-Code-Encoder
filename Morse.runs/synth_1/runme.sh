...
HD_PWD='C:/Users/mpi_l/OneDrive/Desktop/Morse/Morse.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source morse_top.tcl
